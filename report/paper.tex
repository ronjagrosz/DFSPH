...
\subsection{Navier-Stokes}
    ...
    In the equations $\frac{D\rho}{Dt}$ and $\frac{D\textbf{v}}{Dt}$ denotes the derivate of the density $\rho$ and the velocity $\textbf{v}$ respectively. The pressure, kinematic viscosity and body forces are denoted by $p,v$ and $\textbf{f}$ respectively. Due to the incompressibility, the partial derivate of the density with respect to the time is zero which implies the equivalence of the equations in~\ref{eq:nsDensity} where the second part $\bigtriangledown \cdot \textbf{v} = 0$ induce that the field is free from divergence.  
