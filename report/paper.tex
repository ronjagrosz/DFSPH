...
\subsection{Density solver} \label{densitySolver}
    ...
    The velocity is updated according to the the divergence solver. %Det här behöver kanske utvecklas, väntar med det tills stycket om divergence solvern är klar, innehåller samma ekvationer delvis
