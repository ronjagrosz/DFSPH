...
The divergence-free solver ensures the fluid to be free of density change over time by enforcing $\frac{Dp}{Dt} = 0$, which is equivalent to navier-stokes divergence free condition given in equation %\ref{eq:navier}
