...
A condition was proposed by 
Courant$-$Friedrichs$-$Lewy, often refered to as the CFL-condition, which is shown in Equation \ref{eq:cfl}.
...
This is decided from the user side as a desired fps, \textit{frames per second}, parameter.
